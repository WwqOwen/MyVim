...
if g:islinux
    ...
    set rtp+=$VIM/vim_bin/window/glo656wb/bin
endif
...
Plug 'D:\softInstallPath\Vim\vim_bin\window\fzf-0.19.0-windows_amd64\fzf.exe'
...
"如果使用Vim并且想预览数学公式，还需要安装 mathjax-support-for-mkdp。
...
"透明窗口gvim
"https://github.com/mattn/vimtweak.git
...
nnoremap <leader>g :GoToFunImpl<cr>
...
if (g:iswindows && g:isGUI)
    ...
    func! Alpha_add()
        ...
        call libcallnr("vimtweak64.dll","SetAlpha",g:Current_Alpha)
    endfunc
    func! Alpha_sub()
        let g:Current_Alpha = g:Current_Alpha - 10
...
"    Plug 'skywind3000/gutentags_plus'
	...
	let g:gutentags_gtags_cscope_executable = 'D:/softInstallPath/Vim/vim_bin/window/glo656wb/bin/gtags-cscope'
	...
	let g:gutentags_gtags_executable = 'D:/softInstallPath/Vim/vim_bin/window/glo656wb/bin/gtags'

    let $GTAGSLABEL = 'native'
    "pip install pygments --user
	"let $GTAGSLABEL = 'native-pygments' 
    let $GTAGSCONF = 'D:\softInstallPath\Vim\vim_bin\window\glo656wb\share\gtags\gtags.conf'
	
	
	"let g:gutentags_trace = 1
	"let g:gutentags_define_advanced_commands = 1
"    " gutentags 搜索工程目录的标志，当前文件路径向上递归直到碰到这些文件/目录名
    let g:gutentags_project_root = ['_root', '.root']
...
" 指定浏览器路径
let g:mkdp_path_to_chrome = "C:\Users\wang.weiqiong\AppData\Local\Google\Chrome\Application\chrome"
" 指定预览主题，默认Github
...
let g:Lf_RootMarkers = ['_root', '.root', '.project',  '.svn', '.git']
...
let g:ycm_server_python_interpreter='D:\softInstallPath\Python38\python.exe'
" -----------------------------------------------------------------------------
"asyncrun.vim 插件配置 >
" -----------------------------------------------------------------------------
...
let g:asyncrun_rootmarks = ['.bp', '.svn', '.git', '.root', '_root','_darcs', 'build.xml']
"nnoremap <silent> <F7> :AsyncRun . J6Set && mm <cr>
"nnoremap <silent> <F7> :AsyncRun -cwd=<root> -raw mm <cr>
nnoremap <silent> mm :AsyncRun -cwd=<root> -raw . Hikey && mm -j8 <cr>
if g:iswindows
	nnoremap <silent> make :AsyncRun -cwd=<root> -raw ./compile.bat <cr>
	nnoremap <silent> rg :AsyncRun -cwd=<root> -raw -append rg <cword> <cr>
	nnoremap <silent> fd :AsyncRun -cwd=<root> -raw -append fd <cword> <cr>
endif
" -----------------------------------------------------------------------------
"ag.vim 插件配置 >
" -----------------------------------------------------------------------------
...
"------------------------------------------------------------------
"UltiSnips
""插入模式下直接通过<C-d>键来触发UltiSnips的代码块补全
